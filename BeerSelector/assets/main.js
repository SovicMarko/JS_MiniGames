...
function restart() {
  ...
  proveraPolje = 0;
  for (i = 0; i < 24; i ++) {
    document.getElementsByClassName('polje')[i].innerHTML = "";
    document.getElementsByClassName('provera')[i].style.background = "gainsboro";
    if( i < 4 ) {
      document.getElementsByClassName('trazeno')[i].innerHTML = "";
    }
  }
  novaKombinacija();
}
...
function nacrt() {
  ...
  for (i = 0; i < 4; i++) {
    if (i == 0) 
      krugovi.innerHTML += "<div id='prvi' class='trazeno'></div>";
    else 
